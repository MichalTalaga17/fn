            ...
            for (i = 0; i < 4; i++) {
                ...
                markup1 = markup1 +
                    ...
                    <div class="godz godz_${i}">
                        ...
                        <img src="icons/${icon}.png" alt="${description}">
                        <h1 class = "temp">${temp_cel(temp)} ℃</h1>
...
function powietrze() {
    ...
    fetch(url_weather)
        ...
        .then(dane => {
            ...
            const url_air_pollution_local = `https://api.openweathermap.org/data/2.5/air_pollution?lat=${lat}&lang=pl&lon=${lon}&appid=e58dfbc15daacbeabeed6abc3e5d95ca`;
            error.innerHTML = "";
